...
public class DatabaseContract {
    ...
    public static final class ResourceEntry implements BaseColumns {
        ...
        static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_RESOURCE;
        static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_RESOURCE;
...
//        }
    ...
    public static final class DLCEntry implements BaseColumns {
        ...
        static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_DLC;
        static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_DLC;
    ...
    public static final class CompositionEntry implements BaseColumns {
        ...
        static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_COMPOSITION;
        static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_COMPOSITION;
        ...
        // SQL column helpers
        static final String SQL_COLUMN_ID = TABLE_NAME + "." + _ID;
        static final String SQL_COLUMN_ENGRAM_KEY = TABLE_NAME + "." + COLUMN_ENGRAM_KEY;
        //        static final String SQL_COLUMN_RESOURCE_KEY = TABLE_NAME + "." + COLUMN_RESOURCE_KEY;
        static final String SQL_COLUMN_DLC_KEY = TABLE_NAME + "." + COLUMN_DLC_KEY;

        // Query helpers
        static final String SQL_QUERY_WITH_ID = SQL_COLUMN_ID + " = ?";
        static final String SQL_QUERY_WITH_ENGRAM_KEY = SQL_COLUMN_ENGRAM_KEY + " = ?";
...
//                BASE_CONTENT_URI.buildUpon().appendPath( PATH_QUEUE ).build();
        ...
        static final String CONTENT_DIR_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_QUEUE;
        static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/" + CONTENT_AUTHORITY + "/" + PATH_QUEUE;
        ...
        // Foreign key from Engram table
        static final String COLUMN_ENGRAM_KEY = "engram_id";

        // Foreign key from Station table
        //static final String COLUMN_STATION_KEY = "station_id";

        // SQL column helpers
        static final String SQL_COLUMN_ID = TABLE_NAME + "." + _ID;
        static final String SQL_COLUMN_QUANTITY = TABLE_NAME + "." + COLUMN_QUANTITY;
        static final String SQL_COLUMN_ENGRAM_KEY = TABLE_NAME + "." + COLUMN_ENGRAM_KEY;
        ...
        static final String SQL_QUERY_WITH_ENGRAM_TABLE_SELECTION =
                SQL_COLUMN_ENGRAM_KEY + " = " + EngramEntry.SQL_COLUMN_ID +
                        " AND " + EngramEntry.SQL_QUERY_WITH_DLC_KEY;

        static final String[] SQL_PROJECTION = new String[]{
