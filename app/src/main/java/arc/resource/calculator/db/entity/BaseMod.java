...
public class BaseMod {
  ...
  @Ignore
  public BaseMod(String contentFolder, String imageLocationId, String nameId) {
    this(Util.generateUUID(), contentFolder, imageLocationId, nameId);
  }

  public BaseMod(@NonNull String id, @NonNull String contentFolder, @NonNull String imageLocationId, @NonNull String nameId) {
    this.id = id;
