...
public class DlcBlacklistEntity extends StationEntity {
    @NonNull
    private String dlcId;

    @JsonCreator
    public DlcBlacklistEntity(@JsonProperty(cUuid) @NonNull String uuid,
    ...
    public static DlcBlacklistEntity fromJson(JsonNode node) {
        return new ObjectMapper().convertValue(node, DlcBlacklistEntity.class);
    }
