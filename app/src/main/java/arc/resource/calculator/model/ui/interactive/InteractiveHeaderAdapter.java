...
/**
 * Parent class that will hold sections of items to use for headers
 */
public class InteractiveHeaderAdapter extends RecyclerView.Adapter<InteractiveHeaderViewHolder> {
    public static final String TAG = InteractiveHeaderAdapter.class.getCanonicalName();

    private final InteractiveViewModel viewModel;
    private final LayoutInflater layoutInflater;
    private final FragmentActivity fragmentActivity;
    private final List<InteractiveHeader> itemList = new ArrayList<>();

    protected InteractiveHeaderAdapter(Fragment fragment, InteractiveViewModel viewModel) {
        super();
    ...
    @NonNull
    @Override
    public InteractiveHeaderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.d(TAG, "onCreateViewHolder: " + viewType);

        View itemView;
        switch (viewType) {
            case cStationHeaderViewType:
                itemView = getLayoutInflater().inflate(R.layout.search_item_header, parent, false);
                break;
            case cFolderHeaderViewType:
                itemView = getLayoutInflater().inflate(R.layout.search_item_header, parent, false);
                break;
            case cEngramHeaderViewType:
                itemView = getLayoutInflater().inflate(R.layout.search_item_header, parent, false);
                break;
            case cResourceHeaderViewType:
                itemView = getLayoutInflater().inflate(R.layout.search_item_header, parent, false);
                break;
            default:
        ...
        return new InteractiveHeaderViewHolder(itemView);
    }

    protected EngramItemViewHolder createEngramHeaderViewHolder(View itemView) {
        return new EngramItemViewHolder(itemView);
    }

    protected FolderItemViewHolder createFolderHeaderViewHolder(View itemView) {
