...
public class InteractiveItemAdapter extends RecyclerView.Adapter<InteractiveItemViewHolder> {
    public static final String TAG = InteractiveItemAdapter.class.getCanonicalName();
    ...
    protected InteractiveItemAdapter(Fragment fragment, InteractiveViewModel viewModel) {
        super();
