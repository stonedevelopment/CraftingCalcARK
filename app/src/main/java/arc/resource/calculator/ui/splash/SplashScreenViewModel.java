...
public class SplashScreenViewModel extends AndroidViewModel {
    ...
    private void checkVersion() {
        try {
            ...
            String oldVersion = PrefsUtil.getInstance(getApplication()).getVersionByUUID(null); // TODO: 5/30/2020 nullified version check for now, not using SplashScreen at this time
