...
//
//                    JSONDLC JSONDLC = new JSONDLC( dlcName );
//
...
//
//                                JSONDLC.Station station = new JSONDLC.Station( stationName, stationImageFolder, stationImageFile );
//
...
//
//                                JSONDLC.addResource( new JSONDLC.Resource( resourceName, resourceImageFolder, resourceImageFile ) );
//
...
//                    mapper.writeValue( file, JSONDLC);
//
...
//        }
    ...
    private List<JSONDLC.Category> getCategories( ContentResolver r, long dlcId, long parentId, long stationId ) {
        List<JSONDLC.Category> categories = new ArrayList<>();
...
//
//                    JSONDLC.Category category = new JSONDLC.Category( categoryName );
//
...
//
//                                JSONDLC.Engram engram = new JSONDLC.Engram( engramName, engramDescription, engramImageFolder, engramImageFile, engramYield, engramLevel );
//
...
//                                                    engram.addComposite( new JSONDLC.Composite( resourceName, resourceQuantity ) );
//                                                } else {
